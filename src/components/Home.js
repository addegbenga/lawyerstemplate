              ...
              <div className=" lg:w-2/5 lg:mt-8 ">
                <div className="border-b pb-8">
                  ...
                  <p className="text-base tracking-wide opacity-80">
                    Lorem ipsum dolor sit amet, consectetur adipicint elit,
                    justo, euidemd frlsi, eros mi puris ins est. Vitae sodales
                    tellu vitae, tincidat in sed orci. Blandit parin posure dui
                    vitae, Nisi in in nam vivera librrta. Tincidubt viverra
                    congue marbi ut fermentr id
                  </p>
                </div>
            ...
            <div className="lg:w-1/10 cursor-pointer   lg:m-auto lg:flex lg:justify-between">
              <div>
                ...
                <ul className="text-white tracking-widest text-sm opacity-70">
                  <li className="mb-3 hover:text-Primary transition duration-500 ease-in-out">
                    HOME
                  </li>
                  <li className="mb-3 hover:text-Primary transition duration-500 ease-in-out">
                    ABOUT
          ...
          <div className="pt-5 pb-5 px-3">
            <div className="lg:flex lg:w-1/10 lg:m-auto lg:justify-between lg:items-center">
              ...
              <p className="text-xs lead-10 tracking-wider  text-white opacity-80">
                ...
                <span className="text-Primary"> BRIX TEMPLATES- </span> POWERED
                BY
